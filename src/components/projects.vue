  ...
  <div>
    <div class="projects_item"
      ...
      <div>
        ...
        <!-- <input type="text" v-model="names[item.key]" @keydown.enter="toggleEdit($event, item.key)"> -->
        <span class="projects_item_icon item_icon_lock">
          ...
          <!-- <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            width="65" height="75"
            viewBox="0 0 17.197916 18.520834"
            version="1.1">
        ...
        <!-- <span class="projects_item_icon item_icon_edit" @click="toggleEdit($event, item.key)">
        ...
        <!-- <span class="projects_item_icon item_icon_archive" @click="toggleEdit($event, item.key)">
