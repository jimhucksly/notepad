      ...
      case TemplateTypes.Verify:
        return `
          <table style="width: 100%; background-color: #E6EBEC">
            ...
            <tr>
              <td style="text-align: center; font-size: 36px; font-weight: bold; letter-spacing: 4px;">${String(data.code)}</td>
            </tr>
            <tr>
              <td style="padding: 15px 0"></td>
            </tr>
      ...
      case TemplateTypes.ResetPassword:
        return `
          <table style="width: 100%; background-color: #E6EBEC">
            ...
            <tr>
              <td style="text-align: center; font-size: 18px; letter-spacing: 1px;">${String(data.password)}</td>
            </tr>
            <tr>
              <td style="padding: 15px 0"></td>
            </tr>
